...
public class StringMethod2 {
    public static void main(String[] args) {
        ...
        //String Language2 = sentences4.substring(9, 14+1);
        //System.out.println(Language2);

        String email = "yasin@yahoo.com";
        String email1= email.substring(3, 9);
        System.out.println(email1);

        String sen = "today is sunday, tomorrow is monday";
       // String tomorrow = sen.substring(sen.lastIndexOf(" " + 1));
